...
L.addonname = "ART 團隊工具包"
L.openoptionframe = "開啟 ART 團隊工具包"
...
L.NoteHelpAdv3 = "此範例將被替換為選定的首領戰鬥片段的動態計時器。計時器只有在手動啟動後才有效。使用聊天指令 \"|cffffff00/rt note starttimer customevent|r\" or lua function \"|cffffff00GART.F.Note_Timer(\"customevent\")|r\""
L.NoteHelpAdv4 = "此範例將被替換為選定的首領戰鬥片段的動態計時器。此條件將運行weakauras插件的自定義事件。事件名稱 - |cffffff00ART_NOTE_TIME_EVENT|r。事件將在計時器的20、15、10、5、4、3、2、1,0秒觸發。1參數是條件名稱 (|cffffff00nzoth_hs1|r 在此範例), 2參數 - 剩餘時間, 整數, 3參數 - 註記中的文字。"
...
L.InspectViewerNoEARTAddon = "該玩家尚未安裝ART"
...
L.ArrowScale = "縮放"
L.ArrowAlpha = "透明度"
L.ArrowTextBottom = "插件功能支援:\nGART.F.ArrowTextPlayer(\"name\",size) |cffffffff- 自訂箭頭大小 \"size\" (預設為16) 指向自訂玩家目標 \"name\"|r\nGART.F.ArrowTextCoord(X,Y,size) |cffffffff- 自訂箭頭大小 \"size\" (16 as default) 指向 X,Y 座標|r|n|n範例:|n"
L.ArrowFind = "尋回箭頭"
...
L.LoggingStart = "ART: 開始內建戰鬥記錄"
L.LoggingEnd = "ART: 停止內建戰鬥記錄"
...
L.AttendanceChatMessageSaved = "ART: 出勤陣容已保存"
...
L.WACheckerShareTooltip = "團隊中每個有更新 ART 插件版本的玩家都將會收到這個 WA"
