...
L.NoteHelpAdv3 = "Данный пример будет заменен на динамический таймер для определенного времени боя с боссом. Таймер будет активен только после запуска его вручную. Используйте команду чата \"|cffffff00/rt note stMRTtimer customevent|r\" или lua функцию \"|cffffff00GMRT.F.Note_Timer(\"customevent\")|r\""
...
L.BossmodsThoGMRTransit = "транзит"
...
L.marksbMRTmr = "Таймер пулла, сек.:"
...
L.MarksBMRTimerLeftClick = "ЛКМ"
L.MarksBMRTimerRightClick = "ПКМ"
...
L.cd2OtherVisibilityPMRTyType = "По типу группы"
L.cd2OtherVisibilityPMRTyTypeRaid = "В рейде"
...
L.BossWatcherTimeLineCastStMRT = "начинает чтение"
...
L.BossWatcherRecordStMRT = "Запись включена"
...
L.LoggingStMRT = "MRT: Началась автоматическая запись лога"
...
L.RaidGroupsCombatStMRTed = "Бой начался для этих игроков"
...
L.panelmarksSpellCastStMRT = "Начало чтения заклинания"
...
L.ReminderRaidPMRTyUnit = "Игрок рейда/группы"
L.ReminderRaidPMRTyUnitTip = "Всегда активный триггер.\nМожно использовать для подсветки рейдфреймов выбранных игроков."
...
L.ReminderGlowPMRTicles = "Частицы подсветки"
