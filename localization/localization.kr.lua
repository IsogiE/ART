...
PH.InspectViewerNoEARTAddon = "ART 미설치 플레이어"
...
L.ArrowScale = "크기"
L.ArrowAlpha = "투명도"
PH.ArrowTextBottom = "추가 기능:\nGART.F.ArrowTextPlayer(\"name\",size) |cffffffff- \"size\" 크기로 (기본 16) 플레이어에게 \"name\" 이름과 함께 화살표 표시|r\nGART.F.ArrowTextCoord(X,Y,size) |cffffffff- \"size\" 크기로 (기본 16) X,Y 좌표 방향으로 화살표 표시|r|n|n예제:|n"
L.ArrowFind = "화살표 찾기"
...
PH.LoggingStart = "ART: 기록 시작"
PH.LoggingEnd = "ART: 기록 종료"
...
L.AttendanceChatMessageSaved = "ART: 목록 저장됨"
