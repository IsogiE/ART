...
PH.InspectViewerNoEARTAddon = "Spieler hat kein ART"
...
PH.LoggingStart = "ART: Logaufzeichnung gestartet"
PH.LoggingEnd = "ART: Logaufzeichnung beendet"
